...
def find_path_to_end(p_dict, cur_node, time_remaining, running_sum, cur_m, valves_running):
  if time_remaining <= 1:
...
find_path_to_end(p_dict = valve_and_paths, cur_node = 'AA', time_remaining = 6, running_sum = 0, cur_m = 0, valves_running = [])
